# Music & Drama - Year 8 (Prime Book)
> Markdown companion of `public/library/y08-music-and-drama/book.pdf` (2 pages).> RULE: when the PDF is edited, this file must be updated in the same change.
