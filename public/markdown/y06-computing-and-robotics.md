# Computing & Robotics - Year 6 (Prime Book)
...
From clear instructions to real programs that sense and decide. Predict, run,
compare, and fix the bug before the machine does.
INSIDE THIS BOOK
•
From instructions to programs, in units
•
