...
---
Prime Books · Portuguese First Language Ano 9 · Manual do Aluno

Primeira edição, 2026

Publicado pela Prime Books, a chancela editorial da Prime School, www.primeschool.pt

© Prime School 2026. Todos os direitos reservados. Nenhuma parte desta publicação pode ser reproduzida,
guardada num sistema de recuperação, ou transmitida por qualquer forma ou meio sem a autorização prévia por

escrito do editor, exceto para fins de estudo, investigação ou crítica.

Uma publicação independente. Este livro é uma obra original produzida pela Prime School para uso nos seus
próprios programas de estudo. Não é afiliado, licenciado, endossado ou aprovado por Porto Editora, nem por

qualquer entidade examinadora.

Textos originais. Todos os textos literários são obras originais escritas para esta edição. As referências factuais e as

notícias são reais e encontram-se creditadas na secção Fontes e referências.

Edição em português europeu.
...
A Unidade 1 inclui ainda um Projeto final, Verifica o teu progresso, Avalia-te e o Mapa de Palavras.

A seguir

Introdução: como funciona este livro

Como usar este livro

Prepara-te

Unidade 2 · Textos narrativos
...
Este é um livro sobre a tua língua e sobre o poder de a usar bem. Nesta primeira unidade vais ler um texto de opinião

sobre o jornalismo, analisar uma notícia verdadeira com fonte citada, estudar as funções sintáticas da frase e
...
Este livro segue o espírito de um programa de Português, reinterpretado para a Prime School, em quatro vertentes:
Educação Literária, Gramática, Escrita e Oralidade. Cada secção abre com intenções claras e fecha com
autoavaliação.
...
Cada secção segue o mesmo ritmo, por isso sabes sempre onde estás.

Unidade 5 · Textos argumentativos

Mapa de Palavras

Fontes e referências

Textos originais. Cada texto foi escrito para este livro.

Factos verdadeiros. Todas as notícias e dados são reais e citados.

A tua voz conta. Vais falar, ler em voz alta e avaliar o teu trabalho.
...
Nesta unidade, vais
As promessas desta unidade.

Para começar
Um aquecimento rápido.
...
Dica
Uma ajuda para ler ou escrever melhor.

Hora de ligar
Uma notícia verdadeira, com fonte.

Não percas o rumo!
Uma previsão sobre o que vem a seguir.

Hora da diversão!
Um jogo para aprender a brincar.

A tua hora
Frases 'Eu consigo' para te avaliares.

Como trabalhar

Tem sempre um caderno ao lado deste livro. Quando uma secção pede para planeares, escreveres ou anotares, fá-lo
a sério. Quando leres um texto, lê-o duas vezes: uma pela história, outra para veres como foi feito.

PREPARA-TE

Antes da Unidade 1

Só precisas de três coisas: este livro, um caderno e algo para escrever.

A tua mala de leitor

Um teste rápido

Estas perguntas são exactamente o que a Unidade 1 vai explorar.

Vontade de ler o mesmo texto duas vezes, devagar da segunda.

O hábito do dicionário: quando uma palavra te pára, procura-a e usa-a.

A tua voz, porque vais ler em voz alta e defender as tuas ideias.

O que distingue um facto de uma opinião?
1

Como saberias se uma notícia é verdadeira?
2

O que faz um argumento ser convincente?
3
